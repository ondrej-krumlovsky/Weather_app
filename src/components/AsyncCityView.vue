<template>
    <div class="flex flex-col flex-1 items-center justify-center">
        ...
        <div v-if="route.query.preview" class="text-white p-4 bg-weather-secondary w-full text-center">
            <p>
                You are previewing the city, click the "+" icon to start tracking.
            </p>
        </div>
...
const getWeatherData = async () => {
    try {
        const weatherData = await axios.get(`https://api.openweathermap.org/data/2.5/onecall?lat=${route.query.lat}&lon=${route.query.lng}&exclude={part}&appid=9f57512fb39e24af04c4a1688eb29198&units=metric`);
